...
- input: an array
- output: a value from the input array

- goal: to find the element that occurs twice
- rules:
  * array is unordered
...
- algorithm:
  ...
  * increment hash value for the current element as key by one
  * if the current value reaches 2 return it
